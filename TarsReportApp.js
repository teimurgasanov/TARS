...
var REPORT_ON_TIME_SUCCESS_OVERRIDE = `
    showAccepted = function(data) {
      ...
      if (!late) {
        ...
        el.innerHTML = styles + '<div id="acceptedCard"><div id="acceptedMark">TARS</div><div id="acceptedText">Отчёт принят с опозданием</div><div id="acceptedSubtext">Постарайся завтра отправить вовремя.</div><div id="acceptedReminder">TARS проверит фото, чеки и рассылки</div></div>';
      }
