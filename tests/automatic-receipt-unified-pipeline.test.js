...
assert.match(executeBlock, /processPersonalMediaV2\(e, n, s, r, this\.getLogger\(\), t, i, explicitTransferIntent \? "receipt" : explicitPhotoIntent \? "photo" : ""\)/, 'all personal images enter media-v2');
