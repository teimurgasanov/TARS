...
(async () => {
  ...
  assert.strictEqual(appManifest.version, "0.10.19");
  assert.strictEqual(packageManifest.version, "0.10.19");
  assert.strictEqual(packageLock.version, "0.10.19");
  assert.strictEqual(packageLock.packages[""].version, "0.10.19");
