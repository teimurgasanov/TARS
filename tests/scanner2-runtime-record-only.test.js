...
(async () => {
  ...
  assert.strictEqual(appManifest.version, "0.10.29");
  assert.strictEqual(packageManifest.version, "0.10.29");
  assert.strictEqual(packageLock.version, "0.10.29");
  assert.strictEqual(packageLock.packages[""].version, "0.10.29");
