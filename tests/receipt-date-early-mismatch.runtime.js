  ...
  return {
    async post(url, options) {
      ...
      if (url.includes("api.openai.com")) {
        ...
        const value = pass === "vision-fields"
          ? { is_receipt: true, operation_date: null, operation_time: null, amount: null, currency: "unknown", confidence: 0.5 }
...
(async () => {
  ...
  assert.deepStrictEqual(agreedToday.calls, ["openai:vision-fields", "yandex:page", "openai:primary", "openai:amount-focus"]);
